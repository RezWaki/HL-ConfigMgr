...
#pragma endregion
	private: System::Void main_Load(System::Object^  sender, System::EventArgs^  e) {
				 ...
				 //unsigned char alltex2 = System::Convert::ToChar(alltex);
				 //std::string alltext = System::Convert::ToBase64String(cli::array(alltex2), 0, 9999);;
	...
	private: System::Void button1_Click(System::Object^  sender, System::EventArgs^  e) {
				 ...
				 String^ finalcmd = alltex+"\nbind "+textBox2->Text+""+textBox3->Text;
				 std::ofstream file("valve\\config.cfg");
				 char fff = System::Convert::ToChar(finalcmd);
				 file.write(&fff, 1024);
			 }
private: System::Void button2_Click(System::Object^  sender, System::EventArgs^  e) {
			 //const char* cmds = System::Convert::ToChar(textBox1->Text);
			 system("hl.exe");
		 }
};
}
